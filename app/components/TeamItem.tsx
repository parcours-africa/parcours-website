...
const TeamItem: React.FC<TeamCardProps> = ({name, imageUrl, position})=> {
  return (
    <div className={`relative border-[1px] border-secondary h-[400px] bg-accent w-full md:h-[300px] md:w-[230px] rounded-3xl bg-no-repeat bg-center bg-cover`} style={{ backgroundImage: `url('${imageUrl}')`}}>
